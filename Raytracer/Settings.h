...
const float AREA_LIGHT_SAMPLES = 5.0f; // number of samples to take from an area light for a point on a surface
...
const int GLOBAL_PHOTONS_TO_USE = 5000; // global photons to use in irradiance estimate
...
const float FOCUS_DISTANCE = 3.75f; // plane in focus (distance from camera)
#endif