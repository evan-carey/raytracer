...
const int NUM_TRACE_CALLS = 10; // number of bounces to trace each ray
const float AREA_LIGHT_SAMPLES = 50.0f; // number of samples to take from an area light for a point on a surface
...
const int SAMPLES = 100; // number of samples per pixel
...
// Caustic
const int NUM_CAUSTIC_PHOTONS = 100000; // caustic photons per light source
...
const int NUM_PHOTON_CALLS = 8; // max number of bounces to trace each photon
